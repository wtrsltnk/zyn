...
struct ADnoteGlobalParam {
    ...
    // RESONANCE
    class Resonance *Reson;

    //how the randomness is applied to the harmonics on more voices using the
    //same oscillator
...
/*                    VOICE PARAMETERS                     */
/***********************************************************/
struct ADnoteVoiceParam:public Node
{
    ...
    // filter bypass TODO this should be updated to a toggle
