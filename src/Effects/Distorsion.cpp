...
//Effect output
void Distorsion::out(const Stereo<float *> &smp, int sampleFrames)
{
    ...
    waveShapeSmps(/*buffersize*/sampleFrames, efxoutl, Ptype + 1, Pdrive);
    if(Pstereo)
        waveShapeSmps(/*buffersize*/sampleFrames, efxoutr, Ptype + 1, Pdrive);
