 ...
 */
PianoView::PianoView( QWidget * _parent, Piano* _piano ) :
	QWidget( _parent ),             /*!< Our parent */
//	ModelView( NULL, this ),        /*!< Our view Model */
	m_piano( _piano ),                /*!< Our piano Model */
	...
	m_lastKey( -1 )                 /*!< The last key displayed? */
{
	...
	if( s_whiteKeyPm == NULL )
	{
		s_whiteKeyPm = new QPixmap( ":/images/pixmaps/white_key.png" );
	}
	if( s_blackKeyPm == NULL )
	{
		s_blackKeyPm = new QPixmap(  ":/images/pixmaps/black_key.png"  );
	}
	if( s_whiteKeyPressedPm == NULL )
	{
		s_whiteKeyPressedPm = new QPixmap( ":/images/pixmaps/white_key_pressed.png"  );
	}
	if ( s_blackKeyPressedPm == NULL )
	{
		s_blackKeyPressedPm = new QPixmap(  ":/images/pixmaps/black_key_pressed.png"  );
	}
#endif
